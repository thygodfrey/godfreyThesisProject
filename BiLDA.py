...
class BiLDA:
	...
	def readData(self,filename_en,filename_ja):
		f_en=open(filename_en,'r',encoding='utf8')
		wordmap_en=open('wordmap-'+filename_en,'w',encoding='utf8')
		f_ja=open(filename_ja,'r', encoding='utf8')
		wordmap_ja=open('wordmap-'+filename_ja,'w', encoding='utf8')
		...
		print('doc_ja len: ' + str(len(doc_ja)))
		...
		for m in range(self.M_ja):
			...
			for n in range(self.N_ja):
				...
				if words[n] in wordList_ja:
					...
					wordID_ja+=1
					if wordID_ja % 1000==0:
						print( 'Have read '+str(wordID_ja)+' Tagalog words.')
				
				self.documents_ja[m][n]=self.dic_wordTonum_ja[words[n]]

		print('Total '+str(wordID_ja)+' Tagalog words.')
		# exit(1)
		self.V_ja=wordID_ja
		#print wordID
			...
			for m in range(len(self.z_en)):
				...
				for n in range(len(self.z_en[m])):
					...
					for k in range(self.K):
						...
						# print('self.M_ja: ' + str(self.M_ja))
						# print('self.documents_en[m][n]][k]: ' + str(self.nw_en[self.documents_en[m][n]][k]))
						# print('self.nwsum_en[k]: ' + str(self.nwsum_en[k]))
						# print('self.nd_en[m][k]: ' + str(self.nd_en[m][k]))

						# print('m: ' + str(m) + '\tk: ' + str(k))
						# print('self.nd_ja: ')
						# print(len(self.nd_ja))
						# print(self.nd_ja[m])

						# print('self.nd_ja[m][k]: ' + str(self.nd_ja[m][k])) # IndexError: list index out of range
						# print('self.ndsum_en[m]: ' + str(self.ndsum_en[m]))
						# print('self.ndsum_ja[m]: ' + str(self.ndsum_ja[m]))
	...
	def creat_file(self, output_file):
		...
		f_topic_word=open(output_file,'w', encoding='utf8')
		f_topic_word.write('')
		f_topic_word=open(output_file,'a',encoding='utf8')
		#text=''
		for k in range(self.K):
			dic_en=dict()
			dic_ja=dict()
